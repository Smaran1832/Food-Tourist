...
import com.whiteshade.foodtourist.fragments.FAQsFragment
import com.whiteshade.foodtourist.fragments.FavouritesFragment
import com.whiteshade.foodtourist.fragments.HomeFragment
import com.whiteshade.foodtourist.fragments.ProfileFragment
            ...
            * We delay it by 0.1 second*/
            ...
            when (item.itemId) {
                ...
                R.id.favRes -> {
                    ...
                    fragmentTransaction.addToBackStack("FavFragment")
                    fragmentTransaction.commit()
