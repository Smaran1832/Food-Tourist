package com.whiteshade.foodtourist.adapter
...
import com.whiteshade.foodtourist.database.RestaurantDatabase
import com.whiteshade.foodtourist.database.RestaurantEntity
...
class AllRestaurantsAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    RecyclerView.Adapter<AllRestaurantsAdapter.AllRestaurantsViewHolder>() {
        ...
        override fun onBindViewHolder(p0: AllRestaurantsViewHolder, p1: Int) {
            ...
            Picasso.get().load(resObject.imageUrl).error(R.drawable.login_background).into(p0.resThumbnail)
            ...
            if (listOfFavourites.isNotEmpty() && listOfFavourites.contains(resObject.id.toString())) {
                ...
                p0.favImage.setImageResource(R.drawable.ic_action_not_fav)
            }
